...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            ...
            default=0.0001,
            type=float,
            help="Encoder optimizer learning rate",
        )
        self.parser.add_argument(
            "--discriminator_learning_rate",
            default=0.0001,
            type=float,
            help="Discriminator optimizer learning rate",
        )
        self.parser.add_argument(
            "--encoder_optim_name",
            default="adam",
            type=str,
            help="Which encoder optimizer to use",
        )
        self.parser.add_argument(
            "--discriminator_optim_name",
            default="adam",
            type=str,
            help="Which discriminator optimizer to use",
        )
        ...
        self.parser.add_argument(
            ...
            default=0.0,
            type=float,
            help="Adversarial loss multiplier factor",
        )
        self.parser.add_argument(
            "--hyper_d_reg_every",
            type=int,
            default=0,
            help="Interval for applying r1 regularization on discriminator",
        )
        self.parser.add_argument(
            "--hyper_d_r1_gamma",
            type=float,
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=64,
            help="The hyper-paramter D described in the main paper",
        )

        self.parser.add_argument(
            "--step_to_add_adversarial_loss", type=int, default=150000
        )
        self.parser.add_argument(
            "--num_cold_steps",
            type=int,
        ...
        self.parser.add_argument(
            "--resume_training",
            action="store_true",
            help="Resuming training process or not",
        )
        self.parser.add_argument(
            "--checkpoint_path",
            default=None,
        ...
        self.parser.add_argument(
            "--print_interval", default=50, type=int, help="Interval for print metrics"
        )
        self.parser.add_argument(
