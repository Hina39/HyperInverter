...
def run_on_batch(latents, net):
    """

    Args:
        latents (Dict):
            "predicted_weights"と"w_codes"をkeyとして持つ辞書.
            save_latent.pyによって保存される. 含まれる重みは既にtorch.Tensorに
            変換されていることを想定.
...
if __name__ == "__main__":
    ...
    npz_path = pathlib.Path("outputs/latents/63000.npz")
